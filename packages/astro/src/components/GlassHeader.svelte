<script lang="ts">
  ...
  import { M, AnimatePresence } from 'svelte-motion';
...
<header class="top-0 sticky z-50 w-full backdrop-blur-md backdrop-filter bg-background/70 dark:bg-background/40 border-b border-border/40 supports-[backdrop-filter]:bg-background/60">
