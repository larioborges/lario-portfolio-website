  ...
  <div class="container max-w-4xl mx-auto px-6 md:px-4 relative z-10">
    ...
    >
      <div class="text-center md:text-left">
        ...
        <MotionP class="text-xl text-muted-foreground mb-6" variants={childVariants}>
      ...
      >
        <div class="relative">
          <div class="absolute -inset-1 bg-gradient-to-r from--500 to-yellow-500 rounded-full blur opacity-30 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <img
            src="/images/profile.webp"
            alt="Profile"
            class="w-48 md:w-60 rounded-full relative ring-2 ring-yellow-500/50"
    ...
    <MotionWrapper>
      <div class="bg-gradient-to-r from-yellow-500/10 to-green-500/10 backdrop-blur-sm backdrop-filter p-4 rounded-lg border border-yellow-500/20 dark:border-yellow-500/10 shadow-sm">
